...
- `useOrderEntry` - Creating orders
- `useOrderStream` - Retrieving, editing and cancelling orders

## Order entry

The `useOrderEntry` hook provides a variety of supporting functions according to input parameters and the prevailing market data. For more information, please see the [API](/apis/modules/) page.
