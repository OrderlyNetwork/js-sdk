...
import ethersRaw from "@/example/ethers.min.6.7.0.example";
...
<iframe
  src="https://codesandbox.io/p/devbox/wallet-connect-web3-modal-6nqh8y?file=%2Fsrc%2FApp.tsx&embed=1"
  style={{
    width: "100%",
    height: "500px",
    border: 0,
  ...
  title="wallet connect web3 modal"
