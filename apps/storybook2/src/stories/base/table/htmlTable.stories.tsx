...
import {Table, TableCaption,TableHeader, TableRow,TableHead, TableBody, TableCell,TableFooter,Box} from '@orderly.network/ui';
...
render: (args) => {
    return <Box className="oui-bg-white" width={'500px'}>
        <Table>
