...
import { Index, AffiliateLayoutWidget, ReferralProvider } from "@orderly.network/affiliate";
...
const meta = {
  title: "Package/Affiliate/IndexPage",
...
} satisfies Meta<typeof Index.IndexPage>;
