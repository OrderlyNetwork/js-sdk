...
import { SharePnLWidget, SharePnLWidgetId } from '@orderly.network/ui-share';
...
} satisfies Meta<typeof SharePnLWidget>;
...
export const CommandStyle: Story = {
  render: () => {
    return <Button onClick={() => {
      modal.show(SharePnLWidgetId, { currentLeverage: 5 });
    }}>Share PnL</Button>
  },
}