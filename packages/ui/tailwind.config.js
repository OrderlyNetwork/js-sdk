      ...
      colors: {
        ...
        base: {
          ...
          static: {
            ...
            30: "rgb(var(--oui-color-base-static) / 0.30)",
            20: "rgb(var(--oui-color-base-static) / 0.2)",
            16: "rgb(var(--oui-color-base-static) / 0.16)",
            12: "rgb(var(--oui-color-base-static) / 0.12)",
            10: "rgb(var(--oui-color-base-static) / 0.10)",
            8: "rgb(var(--oui-color-base-static) / 0.08)",
            6: "rgb(var(--oui-color-base-static) / 0.06)",
            4: "rgb(var(--oui-color-base-static) / 0.04)",
          },
        },
        line: {
