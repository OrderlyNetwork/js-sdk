...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cnBase(
      "oui-sheet-overlay oui-fixed oui-inset-0 oui-z-50 oui-bg-black/40 oui-backdrop-blur-sm data-[state=open]:oui-animate-in data-[state=closed]:oui-animate-out data-[state=closed]:oui-fade-out-0 data-[state=open]:oui-fade-in-0",
      className,
    )}
    {...props}
    ref={ref}
