    ...
    return (
        <div className={cn("orderly-flex orderly-justify-between", props.className)}>
            <div className="orderly-flex orderly-items-center">
                ...
                <div className="orderly-ml-3 orderly-flex orderly-items-center orderly-justify-center orderly-px-[10px] orderly-py-2 orderly-text-primary orderly-text-[13px] md:orderly-text-[14px] 2xl:orderly-text-[16px] orderly-bg-base-600 orderly-rounded">{code || "-"}</div>
            </div>
            <div className="orderly-flex orderly-items-center">
