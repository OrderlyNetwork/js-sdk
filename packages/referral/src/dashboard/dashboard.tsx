    ...
    return (
        <div className="orderly-bg-base-900 orderly-w-full orderly-h-[912px] orderly-justify-center">
            <div className="orderly-text-base-contrast">
                <div className="orderly-text-[50px]">Earn more as a WOOFi affiliate</div>
                <div className=" orderly-mt-8">Grow your brand | Get 40% commission | Unlock exclusive perks</div>
