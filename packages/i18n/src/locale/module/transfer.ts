export const transfer = {
  ...
  "transfer.convert.quoteInvalidParam":
    "Please check the conversion amount and selected tokens.",
  "transfer.convert.quoteChainUnsupported":
    "This chain is not supported for conversion.",
  "transfer.convert.quoteTokenPairUnsupported":
    "This token pair is not supported for conversion.",
  "transfer.convert.quoteRejected":
    "This quote does not meet the selected risk limits.",
  "transfer.convert.quoteUnavailable":
    "No usable liquidity is available right now. Please try again later.",
  "transfer.convert.quoteDisabled":
    "On-chain conversion is temporarily disabled. Please try again later.",
  "transfer.convert.quoteRateLimited":
    "Too many quote requests. Please try again shortly.",
  "transfer.convert.quoteExternalUnavailable":
    "The quote service is temporarily unavailable. Please try again later.",
  "transfer.convert.priceImpact": "Price impact",
  "transfer.convert.gasFee": "Estimated gas fee",
  "transfer.convert.quoteExpires": "Quote expires",
  "transfer.convert.unavailable": "Unavailable",
