...
function instrument(option?: {
  ...
  return {
    title: i18n.t("orders.column.symbol"),
    dataIndex: "symbol",
    fixed: "left",
...
function side(option?: {
  ...
  return {
    title: i18n.t("orders.column.side"),
    dataIndex: "side",
    width: option?.width,
    // className: "oui-h-[48px]",
    onSort: option?.enableSort
...
function type(option?: {
  ...
  return {
    title: i18n.t("orders.column.type"),
    dataIndex: "type",
    width: option?.width,
...
function quantity(option?: {
  ...
  return {
    title: i18n.t("orders.column.quantity"),
    className: option?.className,
    dataIndex: "quantity",
    width: option?.width,
    onSort:
...
function price(option?: {
  ...
  return {
    title: option?.title ?? i18n.t("orders.column.price"),
    dataIndex: "price",
    className: option?.className,
    width: option?.width,
    onSort:
...
function avgPrice(option?: {
  ...
  return {
    title: i18n.t("orders.column.avgPrice"),
...
function triggerPrice(option?: {
  ...
  return {
    title: i18n.t("orders.column.trigger"),
    className: option?.className,
...
function tpslTriggerPrice(option?: {
  ...
  return {
    title: option?.title ?? i18n.t("orders.column.trigger"),
    className: option?.className,
    ...
    renderPlantText: (value: string, record: any) => {
      ...
      const callback =
        (tp_trigger_price != null
          ? `${i18n.t("orders.tpsl.tp.label")}: ${commifyOptional(
              tp_trigger_price,
              {
                fix: quote_dp,
                padEnd: true,
...
function bracketOrderPrice(option?: {
  ...
  return {
    ...
    renderPlantText: (value: string, record: any) => {
      ...
      const callback =
        (tp_trigger_price != null
          ? `${i18n.t("orders.tpsl.tp.label")} ${tp_trigger_price}`
          : "") +
        (sl_trigger_price != null
          ? `${tp_trigger_price ? "\n" : ""}${i18n.t(
              "orders.tpsl.sl.label"
...
function estTotal(option?: {
  ...
  return {
    title: i18n.t("orders.column.notional"),
    dataIndex: "executed",
    width: option?.width,
    className: option?.className,
    onSort:
...
function realizedPnL(option?: {
  ...
  return {
    title: i18n.t("orders.column.realPnl"),
...
function hidden(option?: {
  ...
  return {
    ...
    renderPlantText: (value: number, record: any) => {
      return value !== 0
        ? i18n.t("orders.column.hidden.no")
        : i18n.t("orders.column.hidden.yes");
    },
...
function fee(option?: {
  ...
  return {
    title: i18n.t("orders.column.fee"),
    dataIndex: "total_fee",
    width: option?.width,
    onSort: option?.enableSort,
    className: option?.className,
...
function status(option?: {
  ...
  return {
    title: i18n.t("orders.column.status"),
    dataIndex: "status",
    width: option?.width,
    onSort: option?.enableSort,
    className: option?.className,
...
function avgOpen(option?: {
  ...
  return {
    title: i18n.t("orders.column.avgOpen"),
    dataIndex: "average_executed_price",
    width: option?.width,
    onSort:
      option?.enableSort ?? false
