...
import {buildQuantityTpslNoMap, formatPnl, getTpslEstPnl, isActivatedTpslOrder } from "./tpsl.util";
...
export class TpslCalService {
    ...
    recalculatePnl(positions: ChartPosition[] | null, pendingOrders: OrderInterface[]) {
