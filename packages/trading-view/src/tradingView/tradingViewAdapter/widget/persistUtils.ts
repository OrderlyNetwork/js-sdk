...
export const getChartData = async (chartKey: string, isLoggedIn: boolean) => {
    ...
    return parseAndCacheChartData(chartKey, localStorageSavedData, localStorageAdapterSetting);
};


export const saveChartData = async (chartKey: string, setting: string, isLoggedIn: boolean) => {
    if (setting) {
...
export const saveChartAdapterSetting = async (chartKey: string, setting: string, isLoggedIn: boolean) => {
    const settingAdapterKey = getChartSettingAdapterKey(chartKey);
...
export const deleteChartData = async (chartKeys: string[], isLoggedIn: boolean) => {
...
export const copyChartData = async (fromChartKey: string, toChartKey: string, isLoggedIn: boolean) => {
