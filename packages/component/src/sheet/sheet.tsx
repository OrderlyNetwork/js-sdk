...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-base-700 p-[20px] shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-260 data-[state=open]:duration-300",
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-lg text-base-contrast", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description
    ref={ref}
    className={cn("text-2xs text-base-contrast-54", className)}
    {...props}
  />
));
