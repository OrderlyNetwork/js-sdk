...
export const PositionEmptyView: FC<{
    ...
    const calcPoistion = (left: number, right: number) => {
        ...
        const rightTargetElement = document.getElementById("table_right_fixed_divide");
    ...
    return (<div
        className="orderly-absolute orderly-left-0 orderly-right-0 orderly-top-[44px] orderly-bottom-0 orderly-bg-base-900"
        style={{
