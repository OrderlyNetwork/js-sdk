...
export const DesktopWalletConnnectButton: FC<AccountStatusProps & {
    className?: string,
    ...
    props
        ...
        return (<DropdownMenu open={state.address ? open : false} onOpenChange={state.address ? setOpen : undefined}>
            <DropdownMenuTrigger>
                <WalletConnectButton
                    status={status}
            ...
            >
                ...
                <div className="orderly-flex">
                    <div className="orderly-flex-1 orderly-flex orderly-items-center orderly-gap-2">
                        ...
                        <Text className="orderly-text-xs orderly-text-base-contrast-80" rule={"address"}>{account.address}</Text>
                    </div>
                        ...
                        <Tooltip>
                            <TooltipTrigger>
                                <IconButton type="button" onClick={onCopy} className="orderly-px-0 orderly-ml-2 orderly-w-[20px]">
                                    {/*@ts-ignore*/}
                                    <Copy size={20} className="orderly-stroke-base-contrast-54 hover:orderly-stroke-base-contrast" />
                                </IconButton>
                            </TooltipTrigger>
                            <TooltipContent
                                align="center"
                        ...
                        <Tooltip>
                            <TooltipTrigger>
                                <IconButton type="button" onClick={onOpenExploer} className="orderly-px-0 orderly-w-[20px]">
                                    {/*@ts-ignore*/}
                                    <Share size={20} className="orderly-stroke-base-contrast-54 hover:orderly-stroke-base-contrast" />
                                </IconButton>
                            </TooltipTrigger>
                            <TooltipContent
                                align="end"
                ...
                <div className="orderly-flex orderly-cursor-pointer orderly-items-center orderly-w-full orderly-h-[24px] orderly-fill-base-contrast-36 orderly-text-base-contrast-36 hover:orderly-fill-danger-light hover:orderly-text-danger-light"
                    onClick={(() => {
                        setOpen(false);
                        onWalletDisconnect?.();
                    })}>
