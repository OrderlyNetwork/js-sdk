...
export const SystemStatusBar: FC<SystemStatusBarProps> = (props) => {
    ...
    return (<>
        <div className="orderly-fixed orderly-bottom-0 orderly-left-0 orderly-right-0 orderly-bg-base-900 orderly-flex orderly-items-center orderly-px-4 orderly-w-full orderly-h-[42px] orderly-justify-between">
