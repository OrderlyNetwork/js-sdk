...
export const OrderTrades: FC<{
    ...
    const body = useMemo(() => {
        ...
        if (data.length === 0) {
            return <tr className="orderly-text-base-contrast-54">
        ...
        return data.map((item) => {
            ...
            return <tr className="orderly-text-base-contrast-54">
                ...
                <td className="orderly-py-1"><Numeral precision={baseDp}>{price}</Numeral></td>
                <td className="orderly-py-1"><Numeral precision={baseDp}>{qty}</Numeral></td>
                <td className="orderly-py-1"><Numeral precision={baseDp}>{total}</Numeral></td>
            </tr>
            ...
            <table className="orderly-w-full orderly-mx-6 orderly-text-2xs">
                <thead className="orderly-py-2 orderly-text-left orderly-text-base-contrast-36 orderly-sticky">
                    <tr className="orderly-bg-base-700">
                        <th className="orderly-w-1/5 orderly-pt-2 orderly-bg-base-700 orderly-sticky orderly-top-0">Transaction ID</th>
                        <th className="orderly-w-1/5 orderly-pt-2 orderly-bg-base-700 orderly-sticky orderly-top-0">Date</th>
                        <th className="orderly-w-1/5 orderly-pt-2 orderly-bg-base-700 orderly-sticky orderly-top-0">Price (USDC)</th>
                        <th className="orderly-w-1/5 orderly-pt-2 orderly-bg-base-700 orderly-sticky orderly-top-0">{`Qty (${base})`}</th>
                        <th className="orderly-w-1/5 orderly-pt-2 orderly-bg-base-700 orderly-sticky orderly-top-0">Total (USDC)</th>
                    </tr>
                </thead>
                <tbody>
                    {body}
