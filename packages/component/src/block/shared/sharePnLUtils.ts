...
export function savePnlInfo(format: PnLDisplayFormat, options: Set<ShareOptions>, bgIndex: number, message: string) {
    
    localStorage.setItem("pnl_config_key",JSON.stringify({
        bgIndex: bgIndex,
        pnlFormat: format,
