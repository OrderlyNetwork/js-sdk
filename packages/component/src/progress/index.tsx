...
const progressVariantsFg = cva("", {
  variants: {
    variant: {
      ...
      gradient: "orderly-bg-gradient-to-r \
      orderly-from-[rgba(255,77,130,1)] \
      orderly-via-[rgba(229,191,115,1)] \
      orderly-via-[rgba(229,210,115,1)] \
      orderly-via-[rgba(229,229,115,1)] \
...
>(({ className, variant = "solid", backgoundClassName, foregroundClassName, value, ...props }, ref) => {
    return (
    ...
    >
      <ProgressPrimitive.Indicator
        className={cn(
          "orderly-h-full orderly-w-full orderly-flex-1 orderly-transition-all",
